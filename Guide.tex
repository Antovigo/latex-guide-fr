...
Cela veut aussi dire que vous avez le droit de le modifier pour l'améliorer.
Il suffit pour cela d'aller sur la page GitHub~:

\url{https://github.com/Nenuphar/latex-guide-fr}\\

N'hésitez pas à faire des modifications, ne serait-ce que pour corriger des fautes d'orthographe. Il peut aussi être intéressant pour vous de jeter un œil au code source, pour avoir un exemple de vrai document LaTeX.\\
